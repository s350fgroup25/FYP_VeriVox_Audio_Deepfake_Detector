...
修復時間統計 + 新增程式整體運行時間 + 動態並發控制（analyze回來就放新檔案）
"""
...
DATASET_CSV = "/home/carmen/asvspoof/preprocess/eval_1000_dataset.csv"
RESULTS_CSV = "/home/carmen/asvspoof/results/platform_eval_results_1000_N1.csv"
SUMMARY_JSON = "/home/carmen/asvspoof/results/platform_eval_summary_1000_N1.json"
...
class PlatformEvaluator:
    ...
    def run_evaluation(self, max_files=1000, max_concurrent=20):
        """動態並發：analyze response回來就放新檔案，總數永遠≤20"""
        print(f"🔥 開始平台真實用戶評估 (動態並發，最大{max_concurrent}個同時處理)...")
    ...
    def generate_report(self):
        ...
        # 🔥 新增精準時間統計區塊
        print("\n📊 總檔案數:   {:>2}".format(time_stats['files_count']))
        ...
        print(f"🎵 真實:{summary['dataset']['real']:>3} | 假:{summary['dataset']['fake']:>3}")
        print()
        ...
        print("📊 METRICS")
        print("-" * 50)
        print(f"EER: {summary['metrics']['eer']:.4f} | AUC: {summary['metrics']['auc']:.4f}")
        print("\n💾 報告完成!")
